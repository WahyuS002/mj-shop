    ...
    <nav id="sidebar">
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{ route('admin.index') }}" class="nav-link"> {{ getSiteName() }}</a>
            </li>
        </ul>

        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu {{ __active('DashboardController', 'index') }}">
                <a href="{{ route('admin.index') }}"
                    aria-expanded="{{ __displayAria(['DashboardController', 'ProfileController'], 'index') }}"
            ...
            <li class="menu menu-heading">
                <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    ...
                    </svg><span>Produk</span></div>
            </li>

            <li class="menu {{ __active('ProductController') }}">
                <a href="{{ route('admin.products.index') }}"
                    aria-expanded="{{ __displayAria('ProductController') }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ __active('BrandController') }}">
                <a href="{{ route('admin.products.brands.index') }}"
                    aria-expanded="{{ __displayAria('BrandController') }}" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu menu-heading">
                <div class="heading"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        stroke-linejoin="round" class="feather feather-circle">
                        <circle cx="12" cy="12" r="10"></circle>
                    </svg><span>PESANAN</span></div>
            </li>

            <li class="menu {{ __active('OrderController', ['index', 'show']) }}">
                <a href="{{ route('admin.orders.index') }}"
                    aria-expanded="{{ __displayAria('OrderController', ['index', 'show']) }}"
                    class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li class="menu {{ __active('SettingController', 'index') }}">
                <a href="{{ route('admin.settings') }}"
                    aria-expanded="{{ __displayAria('SettingController', 'index') }}" class="dropdown-toggle">
                    <div class="">
