            ...
            <div class="row">
                    ...
                    <div class="product__details__pic">
                        <div class="product__details__pic__left product__thumb nice-scroll">
                            @foreach ($product->media as $media)
                                <a class="pt {{ $loop->iteration == 1 ? 'active' : '' }}"
                                    href="#product-{{ $loop->iteration }}">
                ...
                <div class="col-lg-6">
                    <div class="product__details__text">
                        <h3>{{ $product->name }}<span>Brand: <b>{{ $product->brand->name }}</b></span></h3>
                        <div class="rating">
                        ...
                        <div class="product__details__price">
                            ...
                            @else
                                Rp {{ displayPrice($product->price - $product->discount) }} <span>Rp
