                ...
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <p class="signup-link recovery">
                            ...
                            @else
                                Masukkan email Anda dan kami akan mengirim instruksi selanjutnya.
                            @endif
                        </p>
                            ...
                            <div class="form">
                                ...
                                <div id="email-field" class="field-wrapper input">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <a href="{{ route('login') }}" class="forgot-pass-link">Ingin login?</a>
                                    </div>
                                    ...
                                    <input id="email" name="email" type="email" value="{{ old('email') }}"
                                        class="form-control @error('email') is-invalid @enderror" placeholder="Email" required="required" autofocus>
